...
async def get_prompt_enhance_models_v2():
    ...
    return [ItemPromptEnhanceModelV2(name=repo, group=enhance_group(repo), vision=is_vision_model(repo), thinking=is_thinking_model(repo), cached=is_model_cached(repo)) for repo in Options.models]
