...
export function ControlFramePanels({ layout, onPickImage, onClearImage }: ControlFramePanelsProps) {
  ...
  return (
    <>
      ...
      {/* Phase 7: the singular Input panel mount is dropped. The new
          per-frame InputFramePanels orchestrator (mounted from
          CanvasView) renders one panel per frame in inputFrames. Phase 9
          deletes the legacy InputFramePanel function below. */}
