...
// retired in Phase 9 Step 7 (absorbed into InputFrameLayer). This layer
// keeps the global canvasStore.layers mask object render alive until
// Step 10 deletes the file outright; legacy bakedMask state still flows
// through canvasStore.layers between Step 7 and Step 10.
