...
// DndContext + verticalListSortingStrategy SortableContext (Phase 11
// wires onDragEnd; Phase 6 leaves it as a no-op), and renders the
// +Add Input Frame placeholder at the bottom of the input column.
//
// Phase 6 commits this file without mounting it in CanvasView; Phase 7
...
interface InputFramePanelsProps {
  ...
  /** Add a new Input frame at the end of the column. Phase 10 wires
   * default-mode + drag-onto-empty-canvas semantics; Phase 6 leaves a
   * placeholder button. */
