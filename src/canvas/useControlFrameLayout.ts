...
export interface CanvasLayout {
  ...
  /** Phase 4: per-Input-frame layout positions for the multi-Input-frame
   ...
   * Phase 7 swaps consumers over and Phase 9 removes the legacy ones. */
...
export function useControlFrameLayout(): CanvasLayout {
  ...
  return useMemo(() => {
    ...
    // ── Phase 4: multi-Input-frame positions ────────────────────────────
