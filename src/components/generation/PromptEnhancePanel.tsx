...
export function PromptEnhancePanel() {
  ...
  return (
    <div className="flex flex-col gap-2.5">
      ...
      <SwitchRow
        label="Use vision"
        checked={store.useVision}
        onCheckedChange={store.setUseVision}
        disabled={!isVision}
      />
      ...
      <SwitchRow
        ...
        onCheckedChange={store.setThinking}
        disabled={!selectedModel?.thinking}
      />

      <SwitchRow
        label="Keep thinking"
        checked={store.keepThinking}
        onCheckedChange={store.setKeepThinking}
      ...
      <div className="flex flex-col gap-0.5">
        ...
        <Input
          value={store.prefill}
          onChange={(e) => store.setPrefill(e.target.value)}
          placeholder="Prefill model response..."
          className="h-6 text-2xs px-2"
        />
      </div>
      <SwitchRow
        label="Keep prefill"
        checked={store.keepPrefill}
        onCheckedChange={store.setKeepPrefill}
        disabled={store.prefill.length === 0}
      />
        ...
        <div className="flex flex-col gap-2.5">
          <ParamGrid>
            ...
            <ParamSlider
              ...
              onChange={store.setRepetitionPenalty}
              min={1.0}
              max={2.0}
              step={0.05}
            />
          ...
          <div className="grid grid-cols-3 gap-2">
            <div className="flex flex-col gap-0.5">
              ...
              <NumberInput
                ...
                step={64}
                fallback={512}
                className="h-6 text-2xs text-center px-1"
              />
            </div>
            <div className="flex flex-col gap-0.5">
      ...
      <div className="flex items-center gap-2">
        ...
        <NumberInput
          ...
          step={1}
          fallback={-1}
          className="h-6 text-2xs text-center px-1 flex-1"
        />
      </div>
    </div>
  );
