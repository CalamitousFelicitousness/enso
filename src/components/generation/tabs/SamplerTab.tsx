    ...
    <div className="flex flex-col gap-3 text-sm">
      ...
      <ParamSection title="Scheduler" defaultOpen={false}>
        <ParamGrid>
          ...
          <ParamRow
            label="Prediction"
            tooltip={getParamHelp("prediction method")}
          >
            <Combobox
      ...
      <ParamSection title="Timesteps" defaultOpen={false}>
        <ParamGrid>
          ...
          <ParamRow
            label="Override"
            tooltip={getParamHelp("timesteps override")}
          >
            <Input
      ...
      <ParamSection title="Sigma" defaultOpen={false}>
        <ParamGrid>
          <ParamSlider
            label="Start"
            tooltip={getParamHelp("adjust start")}
        ...
        <ParamSlider
          label="Adjust"
          tooltip={getParamHelp("sigma adjust")}
      ...
      <ParamSection title="Seed">
        ...
        <ParamSlider
          label="Var. str."
          tooltip={getParamHelp("variation strength")}
