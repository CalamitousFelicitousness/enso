  ...
  return (
    <div className="space-y-3">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            <Checkbox
              id="extract-te"
              checked={includeTe}
              onCheckedChange={(v) => setIncludeTe(!!v)}
            />

            <Label htmlFor="extract-te" className="text-2xs">
              Text Encoder
            </Label>
          </div>
          <div className="flex items-center gap-2">
            <Checkbox
              id="extract-unet"
              checked={includeUnet}
              onCheckedChange={(v) => setIncludeUnet(!!v)}
            />

            <Label htmlFor="extract-unet" className="text-2xs">
              UNet
            </Label>
          </div>
        </div>
      ...
      <div className="space-y-1">
        <div className="flex items-center gap-2">
          <Checkbox
            id="extract-autorank"
            checked={autoRank}
            onCheckedChange={(v) => setAutoRank(!!v)}
          />

          <Label htmlFor="extract-autorank" className="text-2xs">
            Auto rank
          </Label>
        </div>
        {autoRank && (
      ...
      <div className="flex items-center gap-2">
        ...
        <Label htmlFor="extract-overwrite" className="text-2xs">
          Overwrite existing
        </Label>
      </div>
      ...
      <Button
        ...
        disabled={extract.isPending || !filename}
        className="w-full"
      >
