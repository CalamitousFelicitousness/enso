        ...
        <div className="relative w-36">
          <Input
            ...
            onChange={(e) => {
              ...
              if (e.target.value) onQueryChange("");
            }}
            onKeyDown={handleKeyDown}
      ...
      {entries.length > 0 && (
        <div>
          <button
            ...
            className="flex items-center gap-1 text-3xs text-muted-foreground hover:text-foreground transition-colors py-0.5"
          >
