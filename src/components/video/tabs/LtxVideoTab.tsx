    ...
    <div className="space-y-1">
      ...
      <ParamSection title="Sampling" defaultOpen={false}>
        <ParamGrid>
          <ParamSlider
            label="Steps"
            value={ltxSteps}
            onChange={(v) => setParam("ltxSteps", v)}
            min={1}
            max={100}
            step={1}
          />
      ...
      <ParamSection title="Condition" defaultOpen={false}>
        <ParamSlider
          ...
          onChange={(v) => setParam("ltxConditionStrength", v)}
          min={0}
          max={1}
          step={0.05}
        />
      ...
      <ParamSection title="Upsample" defaultOpen={false}>
        ...
        <ParamSlider
          ...
          onChange={(v) => setParam("ltxUpsampleRatio", v)}
          min={1}
          max={4}
          step={0.5}
      ...
      <ParamSection title="Refine" defaultOpen={false}>
        ...
        <ParamSlider
          ...
          onChange={(v) => setParam("ltxRefineStrength", v)}
          min={0.1}
          max={1}
          step={0.05}
      ...
      <ParamSection title="Advanced" defaultOpen={false}>
        <ParamGrid>
          <ParamSlider
            label="Decode dt"
            value={ltxDecodeTimestep}
            onChange={(v) => setParam("ltxDecodeTimestep", v)}
            min={0}
            max={1}
            step={0.005}
          />
          ...
          <ParamSlider
            label="Noise scale"
            value={ltxNoiseScale}
            onChange={(v) => setParam("ltxNoiseScale", v)}
            min={0}
            max={1}
            step={0.005}
          />
