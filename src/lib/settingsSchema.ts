...
export const settingsSchema: SettingSectionDef[] = [
  ...
  },
  {
    ...
    settings: [
      ...
      {
        key: "diffusers_vae_upcast",
        label: "VAE upcast",
        component: "select",
        defaultValue: "default",
      },
      {
        key: "diffusers_vae_slicing",
        label: "VAE slicing",
        component: "switch",
        defaultValue: false,
      },
      {
        key: "diffusers_vae_tiling",
        label: "VAE tiling",
        component: "switch",
        defaultValue: false,
      },
  ...
  },
  {
    ...
    settings: [
      ...
      {
        key: "prompt_mean_norm",
        label: "Mean normalization",
        component: "switch",
        defaultValue: true,
      },
      {
        key: "comma_padding_backtrack",
        label: "Comma padding",
        component: "number",
        min: 0,
        max: 74,
  ...
  },
  {
    ...
    settings: [
      ...
      {
        key: "use_save_to_dirs_for_ui",
        label: "Save to subdirs",
        component: "switch",
        defaultValue: false,
      },
    ],
  },
  {
    ...
    settings: [
      ...
      {
        key: "outdir_txt2img_samples",
        label: "Text-to-image",
        component: "path",
        baseFolderKey: "outdir_samples",
      },
      {
        key: "outdir_img2img_samples",
        label: "Image-to-image",
        component: "path",
        baseFolderKey: "outdir_samples",
      },
      {
        key: "outdir_control_samples",
        label: "Control",
        component: "path",
        baseFolderKey: "outdir_samples",
      },
      {
        key: "outdir_extras_samples",
        label: "Extras",
        component: "path",
        baseFolderKey: "outdir_samples",
      },
      ...
      {
        key: "outdir_txt2img_grids",
        label: "Text-to-image grids",
        component: "path",
        baseFolderKey: "outdir_grids",
      },
      {
        key: "outdir_img2img_grids",
        label: "Image-to-image grids",
        component: "path",
        baseFolderKey: "outdir_grids",
      },
      {
        key: "outdir_control_grids",
        label: "Control grids",
        component: "path",
        baseFolderKey: "outdir_grids",
      },
  ...
  },
  {
    ...
    settings: [
      {
        key: "postprocessing_enable_in_main_ui",
        label: "Enable in main UI",
        component: "switch",
        defaultValue: false,
      },
      ...
      {
        key: "face_restoration_model",
        label: "Face model",
        component: "select",
        defaultValue: "CodeFormer",
      },
      {
        key: "code_former_weight",
...
export const DEFAULT_QUICK_SETTINGS_KEYS = [
  ...
  "sdnq_quantize_weights_mode",
  "sdnq_quantize_weights_mode_te",
  "sdnq_use_dynamic_quantization",
  "sdnq_use_svd",
];
